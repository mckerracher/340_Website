...
class AddGameForm(FlaskForm):
    nameGame = StringField('Game Name (Required)', validators=[DataRequired(), Length(min=1, max=255)])
    releaseDate = DateField('Release Date (Required)', validators=[DataRequired()])
...
class AddGenreForm(FlaskForm):
    idGenre = IntegerField('Genre ID (Required)', validators=[DataRequired()])
    nameGenre = StringField('Genre Name (Required)', validators=[DataRequired()])
    submit = SubmitField('Submit')


class AddCreatorForm(FlaskForm):
    idCreator = IntegerField('Genre ID (Required)', validators=[DataRequired()])
    nameCreator = StringField('Creator Name (Required)', validators=[DataRequired()])
    submit = SubmitField('Submit')
...
class AddPlatformForm(FlaskForm):
    ...
    playedOnline = StringField('Playable Online? T/F (Required)', validators=[DataRequired()])
    multiPlat = StringField('Playable on Multiple Platforms? T/F (Required)', validators=[DataRequired()])
    submit = SubmitField('Submit')


class AddEpisodeForm(FlaskForm):
    episodeNumber = IntegerField('Episode Number (Required)', validators=[DataRequired()])
    title = StringField('Episode Title (Required)', validators=[DataRequired()])
    episodeDate = DateField('Episode Date (Required)', validators=[DataRequired()])
    submit = SubmitField('Submit')


class AddDistributionPlatformForm(FlaskForm):
    idDistribPlat = IntegerField('Distribution Platform ID (Required)', validators=[DataRequired()])
